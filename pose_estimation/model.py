...
# TODO: this works but is not very pythonic and uses a global function, which is not a good idea
def determine_convolution_kind(func):
    def wrapper(*args, **kwargs):
        global convolution_layer
        if not args[0].config.USE_DEPTH_AWARE_OPS:
            print("original")

            def convolution_layer(filters, kernel_size, strides=(1, 1), padding='valid', data_format=None,
                                  dilation_rate=(1, 1), activation=None, use_bias=True,
                                  kernel_initializer='glorot_uniform', bias_initializer='zeros',
                                  kernel_regularizer=None, bias_regularizer=None, activity_regularizer=None,
                                  kernel_constraint=None, bias_constraint=None):
                return KL.Conv2D(filters, kernel_size, strides, padding, data_format, dilation_rate, activation,
            ...
            def convolution_layer(filters, kernel_size, depth_image, strides=(1, 1), padding='valid', data_format=None,
                                  dilation_rate=(1, 1), activation=None, use_bias=True,
                                  kernel_initializer='glorot_uniform', bias_initializer='zeros',
                                  kernel_regularizer=None, bias_regularizer=None, activity_regularizer=None,
                                  kernel_constraint=None, bias_constraint=None):
                return DKL.Conv2D(filters, kernel_size, depth_image, strides, padding, data_format, dilation_rate,
...
def convolution_layer(filters, kernel_size, depth_image=None, strides=(1, 1), padding='valid', data_format=None,
    ...
    if depth_image is None:
        return KL.Conv2D(filters, kernel_size, strides, padding, data_format, dilation_rate, activation, use_bias,
